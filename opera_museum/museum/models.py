...
class Entry(models.Model):
    ...
    video_name = models.CharField(max_length=60,blank=True, default="", verbose_name="视屏名称")
    video_description = models.CharField(max_length=60,blank=True, default="", verbose_name="视屏描述")
